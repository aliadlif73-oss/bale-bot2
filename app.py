...
def webhook():
    ...
    if step == "choose_type":
        ...
        send_message(
            chat_id,
            "❗ لطفاً نوع گزارش را از دکمه‌ها انتخاب کنید."
        )
        return "ok"
...
"""
    ...
    if step == "result":
        ...
        if text not in valid_results:
            send_message(
                chat_id,
                "❗ لطفاً نتیجه ویزیت را از دکمه‌ها انتخاب کنید."
            )
            return "ok"
    ...
    if step == "followup":
        ...
        if text not in valid_followups:
            send_message(
                chat_id,
                "❗ لطفاً زمان پیگیری را از دکمه‌ها انتخاب کنید."
            )
            return "ok"
